...
describe('Directory FS API route PUT route', () => {
  it('can move file', async () => {
    ...
    expectStatus200(res);
    expect(await fileVerifyFS(filesystemstorageroot, 'moveme.jpg')).toEqual(true);
    ...
    expect(await fileVerifyFS(filesystemstorageroot, 'movehere', 'moveme.jpg')).toEqual(true);
  });
  ...
  it('cannot move file to nonexisting directory', async () => {
    ...
    expectStatus200(res);
    expect(await fileVerifyFS(filesystemstorageroot, 'moveme2.jpg')).toEqual(true);

    const res2 = await moveFile("/moveme2.jpg", "/movehere");
    expectStatus(res2, 404);
    expect(await fileVerifyFS(filesystemstorageroot, 'movehere', 'moveme2.jpg')).toEqual(false);
  });
  ...
  it('can move directory', async () => {
    ...
    expectStatus200(res3);
    expect(await fileVerifyFS(filesystemstorageroot, 'movethisdir', 'moveme.jpg')).toEqual(true);
    ...
    expect(await fileVerifyFS(filesystemstorageroot, 'moveheredir', 'movethisdir')).toEqual(true);
  });
  ...
  it('can rename directory', async () => {
    ...
    expectStatus200(res2);
    expect(await fileVerifyFS(filesystemstorageroot, 'movethisdir1', 'moveme.jpg')).toEqual(true);
    ...
    expect(await fileVerifyFS(filesystemstorageroot, 'moveheredir1')).toEqual(true);
  });
});
